...
# Choose Files
##############
set shrt_t1 = 'wrf_100km' # enter lower resolution file info to be regridded
set title1 = 'WRF_100'    # enter full title 
...
# start loops
set zero = '0'
set q = 2  # change this value to change which type of plot to start with
while ($q <= 12) # var loop
##############
