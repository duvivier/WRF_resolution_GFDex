...
# Choose Files
##############
set shrt_t1 = 'wrf_10km' # enter driving reanalysis title here (options: era_i -> Era interim data for met_em files, wrf_type for different wrf runs)
set title1 = 'WRF_10'  # enter full title of driving reanalysis here to be used in the ncl script
...
# start variable loop
set zero = '0'
set q = 3  # change this value to change which type of plot to start with
    while ($q <= 5) # var loop
