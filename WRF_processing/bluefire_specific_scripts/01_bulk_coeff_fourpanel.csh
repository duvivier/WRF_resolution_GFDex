...
##############
	...
	mv $varcode[$q]_{$title1}_{$title2}_{$date1}.ps  {$outdir}{$compare}{$timetype}{$typeout1}'/'{$varnum}_{$varcode[$q]}_{$title1}_{$title2}_{$date1}.ps
	mv $varcode[$q]_{$title1}_{$title2}_{$date1}.png {$outdir}{$compare}{$timetype}{$typeout2}'/'{$varnum}_{$varcode[$q]}_{$title1}_{$title2}_{$date1}.png
